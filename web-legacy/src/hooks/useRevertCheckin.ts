...
/**
 * Revert a previous check-in so the operator can redo it. Hits
 * /api/mobile/checkin/revert; returns 409 when the participant was never
 * checked in (so the UI can flag the edge case clearly).
 */
