...
/**
 * Groups tickets by orderNumber so multi-ticket purchases show up adjacent
 * and share a color stripe. Single tickets stay unmarked to keep the list
 * clean. Returns a flat array ready to render plus a lookup for the color
 * stripe position.
 */
...
/**
 * Matches a participant against a search term. Case-insensitive; checks
 * name, participantId, orderNumber and any instance field value. Returns
 * true for the empty search, so callers can call it unconditionally.
 */
